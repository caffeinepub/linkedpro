...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "UPDATE": {
      const elements = state.elements.map(
        (e) => e.id === action.id ? { ...e, ...action.changes } : e
      );
      return {
        elements,
        past: pushHistory(state.past, state.elements),
...
const SHAPES = [
  ...
  { label: "Star", shapeType: "star", icon: "★" },
...
function TextEditor({
  ...
  const [val, setVal] = reactExports.useState(el.text || "");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        onKeyDown: (e) => {
          var _a2;
          if (e.key === "Enter" || e.key === " ") (_a2 = fileRef.current) == null ? void 0 : _a2.click();
        },
        onDragOver: (e) => {
          e.preventDefault();
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "#374151" }, children: "Upload files" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "#9CA3AF", marginTop: 4 }, children: "PNG, JPG, GIF, SVG" })
        ]
      }
    ),
    uploads.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function Editor({ onGoHome }) {
  ...
  const [editingTextId, setEditingTextId] = reactExports.useState(null);
  ...
  const [rotating, setRotating] = reactExports.useState(null);
  const [fileMenu, setFileMenu] = reactExports.useState(null);
  const [canvasBg, setCanvasBg] = reactExports.useState("#ffffff");
  const [currentPage, setCurrentPage] = reactExports.useState(0);
  const [pageCount, setPageCount] = reactExports.useState(3);
  const [artboardW, setArtboardW] = reactExports.useState(800);
  const [artboardH, setArtboardH] = reactExports.useState(600);
  const [showCustomSizeModal, setShowCustomSizeModal] = reactExports.useState(false);
  const artboardRef = reactExports.useRef(null);
  ...
  reactExports.useEffect(() => {
    ...
    if (saved) {
      try {
        ...
        if (els == null ? void 0 : els.length) dispatch({ type: "LOAD", elements: els });
      } catch {
      }
    }
  }, []);
      ...
      if (selectedId) {
        ...
        if (e.key === "ArrowLeft") {
          ...
          dispatch({
            type: "UPDATE",
            id: selectedId,
            changes: { x: ((selected == null ? void 0 : selected.x) || 0) - step }
          });
        }
        if (e.key === "ArrowRight") {
          e.preventDefault();
        ...
        if (e.key === "ArrowUp") {
          ...
          dispatch({
            type: "UPDATE",
            id: selectedId,
            changes: { y: ((selected == null ? void 0 : selected.y) || 0) - step }
          });
        }
        if (e.key === "ArrowDown") {
          e.preventDefault();
  ...
  function renderShape(el) {
    const style2 = {
      ...
      opacity: el.opacity,
      transform: `rotate(${el.rotation}deg)`,
      cursor: (dragging == null ? void 0 : dragging.id) === el.id ? "grabbing" : "grab",
      boxSizing: "border-box"
    };
    const isSelected = el.id === selectedId || selectedIds.includes(el.id);
    if (el.strokeColor && el.strokeWidth) {
      style2.outline = `${el.strokeWidth}px solid ${el.strokeColor}`;
    }
    if (isSelected) {
      style2.outline = "2px solid #3B82F6";
    }
    if (el.shapeType === "circle") {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: { ...style2, borderRadius: "50%", background: el.fill },
          ...
          children: isSelected && renderHandles(el)
        },
        el.id
      );
    }
    if (el.shapeType === "triangle") {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: { ...style2, background: "transparent", overflow: "hidden" },
          onMouseDown: (e) => startDrag(e, el),
          onClick: (e) => {
            e.stopPropagation();
            setSelectedId(el.id);
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flex: 1, overflow: "hidden" }, children: [
          ...
          showCustomSizeModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
            CustomSizeModal,
            {
              onApply: (w, h) => {
                setArtboardW(w);
...
function TopNav({
  ...
  const [name, setName] = reactExports.useState(projectName);
  reactExports.useEffect(() => setName(projectName), [projectName]);
  const COLLAB = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
                ...
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "svg",
                    {
                      ...
                      "aria-hidden": "true",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "DesignStudio" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2", y: "2", width: "5", height: "5", rx: "1", fill: "white" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "rect",
                          {
                            x: "9",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "9", y: "9", width: "5", height: "5", rx: "1", fill: "white" })
                      ]
                    }
                  )
                }
        ...
        editingName ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          "button",
          {
            ...
            children: [
              projectName,
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 11, color: "#9CA3AF" }, children: "✎" })
            ]
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", alignItems: "center" }, children: COLLAB.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              width: 28,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#9CA3AF", fontSize: 12, marginLeft: 4 }, children: "All saved" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function CustomSizeModal({
  ...
  const [w, setW] = reactExports.useState(800);
  const [h, setH] = reactExports.useState(600);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                children: "Custom Canvas Size"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 16, marginBottom: 20 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    min: 1,
                    max: 9999,
                    onChange: (e) => setW(Math.max(1, Number.parseInt(e.target.value) || 1)),
                    style: {
                      width: "100%",
                      padding: "8px 12px",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    min: 1,
                    max: 9999,
                    onChange: (e) => setH(Math.max(1, Number.parseInt(e.target.value) || 1)),
                    style: {
                      width: "100%",
                      padding: "8px 12px",
                      border: "1.5px solid #E5E7EB",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 22 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: PRESETS.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
function MenuBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: Object.keys(MENU_ITEMS).map((label) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        fileMenu === label && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
            ...
            children: MENU_ITEMS[label].map(
              (item) => item === "─" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                "button",
                {
                  ...
                  onClick: () => {
                    var _a2;
                    (_a2 = ACTION_MAP[item]) == null ? void 0 : _a2.call(ACTION_MAP);
                    setFileMenu(null);
                  },
                  children: item
                },
...
function SidebarRail({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: SIDEBAR_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          style: {
            ...
            gap: 2,
            marginBottom: 2,
            borderLeft: activeTab === tab.id ? "3px solid #6D5EF6" : "3px solid transparent",
            transition: "all 0.15s"
          },
          onMouseEnter: (e) => {
            if (activeTab !== tab.id)
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 18, lineHeight: 1 }, children: tab.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 10, fontWeight: 500 }, children: tab.label })
          ]
        },
        tab.id
      ))
...
function ContentPane({
  ...
  const [paneWidth, setPaneWidth] = reactExports.useState(240);
  const isDraggingPane = reactExports.useRef(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "12px 12px 8px", flexShrink: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              value: search,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, overflowY: "auto", padding: "0 12px 12px" }, children: [
          activeTab === "templates" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHead, { children: "Recent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHead, { children: "Social Media" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: ["#0EA5E9", "#8B5CF6", "#14B8A6", "#F97316"].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      height: 80,
          ...
          activeTab === "elements" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHead, { children: "Shapes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: SHAPES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    onClick: () => onAddElement({
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 10, color: "#6B7280" }, children: s.label })
                    ]
                  },
                  s.shapeType
                ))
          ...
          activeTab === "text" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: TEXT_PRESETS.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => onAddElement({
          ...
          activeTab === "uploads" && /* @__PURE__ */ jsxRuntimeExports.jsx(UploadPane, { onAddElement }),
          activeTab === "photos" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHead, { children: "Stock Photos" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
          ...
          activeTab === "icons" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHead, { children: "Icons" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: ICONS_SVG.map((icon) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => onAddElement({
          ...
          activeTab === "backgrounds" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHead, { children: "Solid Colors" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: BG_COLORS.slice(0, 12).map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHead, { children: "Gradients" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: BG_COLORS.slice(12).map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    onClick: () => onChangeCanvasBg(c),
                    onKeyDown: (e) => {
...
function CanvasArea({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexShrink: 0 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Ruler, { orientation: "h", length: artboardW, zoom })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flex: 1, overflow: "hidden" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Ruler, { orientation: "v", length: artboardH, zoom }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: elements.map(
                    (el) => el.type === "text" ? renderText(el) : el.type === "image" ? renderImage(el) : renderShape(el)
                  )
                }
              )
            }
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                Array.from({ length: pageCount }, (_, i) => i).map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
...
function PropertiesPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "12px 16px", borderBottom: "1px solid #E5E7EB" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 13, fontWeight: 600, color: "#111827" }, children: selected ? selected.type === "text" ? "📝 Text" : selected.type === "shape" ? "🔷 Shape" : "🖼 Image" : "🎨 Canvas" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "12px 16px", flex: 1, overflowY: "auto" }, children: [
          !selected && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { children: "Background" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ColorRow, { value: canvasBg, onChange: setCanvasBg }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { style: { marginTop: 16 }, children: "Canvas Size" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(PropInput, { label: "Width", value: "800", onChange: () => {
                  } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(PropInput, { label: "Height", value: "600", onChange: () => {
                  } })
                ]
              }
            )
          ] }),
          (selected == null ? void 0 : selected.type) === "text" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { children: "Font" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "select",
              {
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { children: "Weight" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "select",
                      {
                        ...
                        style: SelectStyle,
                        children: FONT_WEIGHTS.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: w, children: FONT_WEIGHT_LABELS[w] }, w))
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { children: "Size" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { style: { marginTop: 12 }, children: "Color" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ColorRow,
              {
                value: selected.fill,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { style: { marginTop: 12 }, children: "Alignment" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 4 }, children: ["left", "center", "right", "justify"].map((align) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                style: {
                  ...
                  borderRadius: 6,
                  border: "1px solid #E5E7EB",
                  background: selected.textAlign === align ? "#EEE9FF" : "#fff",
                  color: selected.textAlign === align ? "#6D5EF6" : "#374151",
                  cursor: "pointer",
                  fontSize: 14
                },
                children: { left: "⬱", center: "☰", right: "⬲", justify: "≡" }[align]
              },
              align
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { style: { marginTop: 12 }, children: "Style" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(PositionSize, { el: selected, onUpdate })
          ] }),
          (selected == null ? void 0 : selected.type) === "shape" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { children: "Fill Color" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ColorRow,
              {
                value: selected.fill,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { children: "Stroke" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ColorRow,
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { children: "Width" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "number",
            ...
            selected.shapeType === "rectangle" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { style: { marginTop: 12 }, children: "Border Radius" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(PositionSize, { el: selected, onUpdate }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { style: { marginTop: 12 }, children: "Layer" }),
          ...
          (selected == null ? void 0 : selected.type) === "image" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              OpacityRow,
              {
                value: selected.opacity,
...
function ColorRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "label",
      {
        ...
        children: !isGradient && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
...
function OpacityRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 12 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PropLabel, { children: [
      "Opacity: ",
...
function PositionSize({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 1, background: "#E5E7EB", margin: "16px 0" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { children: "Position" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PropLabel, { children: "Rotation" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "number",
        value: Math.round(el.rotation),
        onChange: (e) => onUpdate({ rotation: Number.parseInt(e.target.value) || 0 }),
        style: InputStyle
      }
    )
  ] });
...
function PropInput({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "#9CA3AF", marginBottom: 3 }, children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        value,
...
function Home({ onOpenEditor }) {
  const [category, setCategory] = reactExports.useState("All");
  const [search, setSearch] = reactExports.useState("");
  const [onboarding, setOnboarding] = reactExports.useState(
    () => !localStorage.getItem("ds_onboarded")
  );
  const [step, setStep] = reactExports.useState(0);
  const filtered = TEMPLATES.filter(
    (t) => (category === "All" || t.category === category) && t.name.toLowerCase().includes(search.toLowerCase())
  );
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "header",
          {
            ...
            children: [
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "svg",
                          {
                            ...
                            "aria-hidden": "true",
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "DesignStudio Logo" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2", y: "2", width: "5", height: "5", rx: "1", fill: "white" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "rect",
                                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { style: { display: "flex", gap: 4, alignItems: "center" }, children: ["Features", "Templates", "Pricing", "Learn"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            style: {
              background: "linear-gradient(135deg, #6D5EF6 0%, #8B5CF6 50%, #EC4899 100%)",
              padding: "60px 32px",
              textAlign: "center",
              color: "#fff"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  ...
                  children: "Design anything. Share everywhere."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 18, opacity: 0.85, margin: "0 0 28px" }, children: "Choose from thousands of templates or start from scratch." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 1200, margin: "0 auto", padding: "32px 24px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: "#111827", fontSize: 15 }, children: "Create blank canvas" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#6B7280", fontSize: 13 }, children: "Start from scratch with a custom size" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#6D5EF6", fontWeight: 600, fontSize: 14 }, children: "Open Editor →" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: filtered.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  onClick: onOpenEditor,
                  onKeyDown: (e) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "10px 12px" }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "#9CA3AF", marginTop: 2 }, children: t.category })
                    ] })
                  ]
                },
                t.id
        ...
        onboarding && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "fixed",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 56, marginBottom: 16 }, children: ONBOARDING_STEPS[step].icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h2",
                    {
                      style: {
                      ...
                      children: ONBOARDING_STEPS[step].title
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: ONBOARDING_STEPS[step].desc
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: ONBOARDING_STEPS.map((step_item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            width: i === step ? 20 : 8,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 10, justifyContent: "center" }, children: [
                    ...
                    step < ONBOARDING_STEPS.length - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        onClick: () => setStep((s) => s + 1),
...
function App() {
  ...
  return view === "home" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Home, { onOpenEditor: () => setView("editor") }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Editor, { onGoHome: () => setView("home") });
}
